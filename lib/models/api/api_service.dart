...
Future<bool> login(var data) async {
  final SharedPreferences prefs = await SharedPreferences.getInstance();
   final response = await client.post("$baseUrl/Siska_api/login",body: data);
...
Future<bool> loginSa(var data) async {
  final SharedPreferences prefs = await SharedPreferences.getInstance();
   final response = await client.post("$baseUrl/Siska_api/login_superadmin",body: data);
   if (response.body == "null") {
      return false;
    } else {
       await prefs.clear();
  ...
  Future<String> register(File imageFile,var data) async {
   ...
   final responseAdd = await client.post("$baseUrl/Siska_api/registerAddDB",body:dataAdd);
  ...
  Future<List<Profile>> getProfiles() async {
    ...
    final response =  await client.post("$baseUrl/Siska_api/login_profile",body: data);
   ...
   Future<bool> approveDB(String id,String status) async {
    ...
    final response =  await client.post("$baseUrl/Siska_api/ApproveregisterAddDB",body: data);
    if (response.statusCode == 200) {
      return true;
    } else {
      return false;
   ...
   Future<String> getAuthJab() async {
    ...
    final response =  await client.post("$baseUrl/Siska_api/token_update",body: data);
    if (response.statusCode == 200) {
      await prefs.clear();
      client.close();
      return true;
 ...
 Future<bool> deletePesan(String idDetil) async {
    ...
    final response =  await client.post("$baseUrl/Siska_api/delete_pesan",body: data);
    if (response.statusCode == 200) {
     // await prefs.clear();
      client.close();
      return true;
...
if(idProdi!=null){
  final data= {
    ...
    final response =  await client.post("$baseUrl/Siska_api/get_user_all",body: data);
    if (response.statusCode == 200) { // 
      if(response.body=="0"){
       return [];
      }else{
...
if(idProdi!=null){
  final data= {
    ...
    final response =  await client.post("$baseUrl/Siska_api/get_registrasi_by_prodi",body: data);
   ...
   Future<List<Prodi>> getProdi() async {
    ...
    final response =  await client.post("$baseUrl/Siska_api/get_prodi_all",body: data);
    if (response.statusCode == 200) {
...
Future<List<News>> getNews() async {
 var client = new http.Client();
    ...
    final response =  await client.post("$baseUrl/Siska_api/getNews",body: data);
    print(response.body);
    if (response.statusCode == 200) {
      client.close();
      if(response.body=="0"){
 ...
 var client = new http.Client();
    ...
    final response =  await client.post("$baseUrl/Siska_api/get_timeline_penelitian",body: data);
    print(response.body);
    if (response.statusCode == 200) {
      client.close();
      if(response.body=="0"){
 ...
 var client = new http.Client();
    ...
    final response =  await client.post("$baseUrl/Siska_api/get_timeline_penelitian_by_nim",body: data);
    print(response.body);
    if (response.statusCode == 200) {
      client.close();
 ...
 var client = new http.Client();
    ...
    final response =  await client.post("$baseUrl/Siska_api/getJadwal",body: data);
 ...
 var client = new http.Client();
    ...
    final response =  await client.post("$baseUrl/Siska_api/read_pesan",body: data);
    if (response.statusCode == 200) {
      client.close();
      return true;
    } else {
...
if(idProdi!=null){
      ...
      final response =  await client.post("$baseUrl/Siska_api/get_notif_penerima",body: data);
      if (response.statusCode == 200) {
        client.close();
      if(response.body=="0"){
       return [];
  ...
  var client = new http.Client();
      ...
      final response =  await client.post("$baseUrl/Siska_api/get_masa_studi",body: data);
      if (response.statusCode == 200) {
        client.close();
  ...
  var client = new http.Client();
      ...
      final response =  await client.post("$baseUrl/Siska_api/get_masa_studi_dosen_count",body: data);
      if (response.statusCode == 200) {
        client.close();
  ...
  var client = new http.Client();
      ...
      final response =  await client.post("$baseUrl/Siska_api/get_notif_penerima_unread",body: data);
      if (response.statusCode == 200) {
        client.close();
  ...
  var client = new http.Client();
      ...
      final response =  await client.post("$baseUrl/Siska_api/get_registrasi_new",body: data);
      if (response.statusCode == 200) {
        client.close();
  ...
  var client = new http.Client();
      ...
      final response =  await client.post("$baseUrl/Siska_api/get_mhs_pengajuan_by_angkatan",body: data);
      if (response.statusCode == 200) {
        client.close();
  ...
  var client = new http.Client();
      ...
      final response =  await client.post("$baseUrl/Siska_api/get_mhs_proposal_by_angkatan",body: data);
      if (response.statusCode == 200) {
        client.close();
  ...
  var client = new http.Client();
      ...
      final response =  await client.post("$baseUrl/Siska_api/get_mhs_pratesis_by_angkatan",body: data);
      if (response.statusCode == 200) {
        client.close();
        return  penelitianDashFromJson(response.body);
      } else {
  ...
  var client = new http.Client();
      ...
      final response =  await client.post("$baseUrl/Siska_api/get_mhs_tesis_by_angkatan",body: data);
      if (response.statusCode == 200) {
        client.close();
        return  penelitianDashFromJson(response.body);
      } else {
...
Future<List<MhsDash>> getDashMhsAktif() async {
  var client = new http.Client();
      ...
      final response =  await client.post("$baseUrl/Siska_api/get_mhs_aktif_by_angkatan",body: data);
      if (response.statusCode == 200) {
        client.close();
  ...
  var client = new http.Client();
      ...
      final response =  await client.post("$baseUrl/Siska_api/get_mhs_tidakaktif_by_angkatan",body: data);
      if (response.statusCode == 200) {
        client.close();
        return  mhsDashFromJson(response.body);
      } else {
  ...
  var client = new http.Client();
      ...
      final response =  await client.post("$baseUrl/Siska_api/get_topik_penelitian",body: data);
      if (response.statusCode == 200) {
        client.close();
  ...
  var client = new http.Client();
      ...
      final response =  await client.post("$baseUrl/Siska_api/get_total_pembimbing_1",body: data);
      if (response.statusCode == 200) {
        client.close();
 ...
 var client = new http.Client();
    ...
    final response =  await client.post("$baseUrl/Siska_api/kirim_pesan",body: data);
    if (response.statusCode == 200) {
      client.close();
      return true;
    } else {
  ...
  Future<String> settingProfile(File imageFile,var data) async {
    ...
    final responseAdd = await client.post("$baseUrl/Siska_api/settingProfileAddDB",body:dataAdd);
    String status =jsonDecode(responseAdd.body); 
    return status;
     }else{
