 ...
 void filterData(String key) async{
    ...
    if(key.length >=2){
      listData.forEach((item) {
        if(item.nama.toLowerCase().contains(key.toLowerCase()) || item.tgl .toLowerCase().contains(key.toLowerCase()) ){
