...
hr,
            ...
            _jabatan=='0'? Card(
               child: InkWell(
                child: ListTile(
                  leading: Icon(LineIcons.line_chart, color: Colors.blue,),
             ...
             Card(
               child: InkWell(
                child: ListTile(
                  leading: Icon(LineIcons.bar_chart, color: Colors.blue,),
             ...
             Card(
               child: InkWell(
                child: ListTile(
                  leading: Icon(LineIcons.gears, color: Colors.blue,),
              ...
              _isAdmin=='1'? Card(
               child: InkWell(
                child: ListTile(
                  leading: Icon(LineIcons.refresh,color: Colors.green,),
